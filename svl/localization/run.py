...
if __name__ == "__main__":
    ...
    map_reader = SatelliteMapReader(
        db_path="/content/drive/MyDrive/Aerial-Template-Matching/kermanshah_data/output_tiles/",
        resize_size=(1024,),
    ...
    streamer = DroneImageStreamer(
        image_folder="/content/drive/MyDrive/Aerial-Template-Matching/kermanshah_data/satellite_tiles/17/Bing_Map_Tiles/",
        has_gt=True,
